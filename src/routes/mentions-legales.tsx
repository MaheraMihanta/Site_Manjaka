  ...
  return (
    <PageShell>
      ...
      <section className="mx-auto max-w-3xl space-y-4 px-4 py-16 text-sm leading-relaxed text-night/80 sm:px-6 lg:px-8">
        {lang === "fr" ? (
          <>
            <p><strong>Éditeur :</strong> M2A Logistique — France.</p>
            <p><strong>Contact :</strong> contact@m2a-logistique.fr — +33 6 00 00 00 00.</p>
          ...
          <>
            <p><strong>Publisher:</strong> M2A Logistique — France.</p>
            <p><strong>Contact:</strong> contact@m2a-logistique.fr — +33 6 00 00 00 00.</p>
