      ...
      <section className="mx-auto max-w-3xl space-y-4 px-4 py-16 text-sm leading-relaxed text-night/80 sm:px-6 lg:px-8">
        {lang === "fr" ? (
          <>
            ...
            <p>Aucune donnée n'est cédée à des tiers. Conformément au RGPD, vous disposez d'un droit d'accès, de rectification et de suppression de vos données en écrivant à contact@m2a-logistique.fr.</p>
          ...
          <>
            ...
            <p>No data is shared with third parties. Under GDPR, you have the right to access, rectify and delete your data by writing to contact@m2a-logistique.fr.</p>
